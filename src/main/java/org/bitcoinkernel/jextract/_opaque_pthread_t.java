...
public class _opaque_pthread_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        bitcoinkernel_h.C_LONG.withName("__sig"),
        bitcoinkernel_h.C_POINTER.withName("__cleanup_stack"),
        MemoryLayout.sequenceLayout(8176, bitcoinkernel_h.C_CHAR).withName("__opaque")
