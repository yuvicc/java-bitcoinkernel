...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        bitcoinkernel_h.C_POINTER.withName("__routine"),
        bitcoinkernel_h.C_POINTER.withName("__arg"),
        bitcoinkernel_h.C_POINTER.withName("__next")
    ...
    public final static class __routine {
        ...
        private static final MethodHandle UP$MH = bitcoinkernel_h.upcallHandle(__routine.Function.class, "apply", $DESC);
